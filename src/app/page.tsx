...
const copyByLang = {
  ja: {
    ...
    nomineeDesc: 'Site of the Day を取れました。ありがとうございます。',
    nomineeCta: '受賞ページを見る',
    conceptLabel: '01 / CONCEPT',
    conceptLeadBefore: '静的な「情報の羅列」から、息づく',
    conceptLeadHighlight: '「体験」',
    conceptLeadAfter: 'へ。',
    conceptDesc: '大阪の気象データとリアルタイムに同期し、画面の中に息づく空を描き出す。スキルや作品といった静的な情報を、3D表現とモーションによって直感的な「体験」へと昇華させる。',
  ...
  en: {
    ...
    nomineeDesc: 'I won Site of the Day. Thank you for checking it out.',
    nomineeCta: 'View CSS Winner',
    conceptLabel: '01 / CONCEPT',
