...
const copyByLang = {
    ja: {
        ...
        sectionCareer: '経歴',
        careerText:
            'ECCコンピュータ専門学校在学（29卒）。3D・WebGLによる体験設計を軸に、Node.js/ExpressやGoによるAPI・リアルタイム通信、PostgreSQLによるデータ永続化、Docker・Cloud Run・Render向けのデプロイ構成まで、フロントエンドからバックエンドまで実装しています。',
        ...
        activities: [
            ...
            '技育祭2026 福岡 参加（6/20）',
            '技育祭2026 関西 アンバサダー参加（7/11）',
            'STORES Tech Conf 2026 参加（8/31）',
            'DroidKaigi 2026 参加（9/1–3）',
            'iOSDC Japan 2026 参加（9/11–13）',
            'Go Conference 2026 参加',
            '技育祭2026【秋】東京 アンバサダー参加予定（10/10–11）',
    ...
    en: {
        ...
        careerText:
            'I am currently studying at ECC Computer College (Class of 2029). I build interactive 3D web experiences while also working across APIs, real-time communication, data persistence with PostgreSQL, and deployment configurations for Docker, Cloud Run, and Render.',
        ...
        achievements: [
            ...
            'Demo Stage Grand Prize - GitHub Planet',
            'E Exhibition Corporate Award - Matsunya',
        ],
        ...
        activities: [
            ...
            'STORES Tech Conf 2026 - Attended (Aug 31)',
            'DroidKaigi 2026 - Attended (Sep 1–3)',
            'iOSDC Japan 2026 - Attended (Sep 11–13)',
            'Go Conference 2026 - Attended',
            'Geek Festival 2026 [Autumn] Tokyo - Ambassador (Planned, Oct 10–11)',
