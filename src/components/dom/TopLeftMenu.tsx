    ...
    const handleCliCommand = (rawInput: string) => {
        ...
        if (sudoMatch) {
            ...
            const presetMap: Record<string, { season: SeasonType; weather: WeatherType; seasonEvent?: SeasonEventType }> = {
                ...
                tsuyu: { season: 'summer', weather: 'Rain', seasonEvent: 'tsuyu' },
                hatsuhinode: { season: 'winter', weather: 'Morning', seasonEvent: 'first_light' },
                tasuhinode: { season: 'winter', weather: 'Morning', seasonEvent: 'first_light' },
                ...
                yukigeshiki: { season: 'winter', weather: 'Snow' },
            };
