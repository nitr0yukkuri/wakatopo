...
export default function NomineeToast({ href, label, title, description, cta }: NomineeToastProps) {
    return (
        <a
            ...
            className="mb-4 ml-0 md:ml-auto inline-flex w-full flex-col rounded-xl border border-cyan-300/20 bg-black/45 px-3 py-2 text-left backdrop-blur-sm transition-colors hover:border-cyan-200/55 hover:bg-black/65"
            style={{ maxWidth: 320 }}
        >
